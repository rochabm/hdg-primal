...
c
c     test if PETSc is working fine
c
c$$$      call UserInitializeLinearSolver(10,10,userctx,ierr)
c$$$      call UserTestPETSc(userctx)
c$$$      call UserFinalizeLinearSolver(userctx,ierr)
...
c
c     show information for new problem
c
      write(*,*)
...
c
      ...
      type(User) userctx
c
c     clear left and right hand side (old: clear mpalhs, mpdlhs, size nalhs)
c
...
c
c     Neumann BCs not implemented
c
      
c
c     debug
c      
c$$$      write(*,*) "debug array idside"
c$$$      do il=1,6
c$$$         write(*,*) il, (idside(il,j),j=1,4)
c$$$      end do
c$$$c      
c$$$      write(*,*) "debug array lado(.,.)"
c$$$      do kk=1,numel
...
c     for assembling the static condensed matrix (in terms of multp.)
c     for the problem
c------------------------------------------------------------------------------
      use UserModule
c
...
c$$$         write(*,'(A)') " array dl"
c$$$         do kk=1,6
c$$$            write(*,'(24F8.4)') (dl(1,4*(kk-1)+jj),jj=1,4)
c$$$         end do
c$$$         write(*,'(A)') " elem nodes"
c$$$         do kk=1,nen
c$$$            write(*,'(3F8.4)') xl(1,kk), xl(2,kk), xl(3,kk)
c$$$         end do         
c
