...
c      call PetscOptionsCreate(options,ierr)
c      call PetscOptionsGetInt(options,PETSC_NULL_CHARACTER,
c     &    '-n',n,flg,ierr)
c      call PetscOptionsDestroy(options,ierr)
